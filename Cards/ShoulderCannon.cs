    ...
    class ShoulderCannon : CustomCard
    {
        ...
        public class SingleBulletMono : MonoBehaviour
        {
            ...
            private void Update()
            {
                ...
                var _projectiles = _gun.numberOfProjectiles * 0;
                var __projectiles = _projectiles + 1;
                var _bursts = _gun.bursts * 0;
                var __bursts = _bursts + 1;
                var _spread = _gun.spread * 0;

                _gun.numberOfProjectiles = __projectiles;
                _gun.bursts = __bursts;
                _gun.spread = _spread;
            }
        }
    }
