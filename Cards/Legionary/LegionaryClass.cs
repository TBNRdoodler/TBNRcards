...
namespace TBNRcards.Cards.Legionary
{
    public class LegionaryClass : ClassHandler
    {
        ...
        public override System.Collections.IEnumerator Init()
        {
            ...
            while (!(Legionary.Card && FasterParrying.Card && IronReinforcements.Card && AggressiveBlocking.Card && Buckler.Card && SlightWeightReduction.Card && LargeWeightReduction.Card && RomanAthleticism.Card && Scutum.Card && WeakShieldReinforcements.Card && StrongShieldReinforcements.Card && RomanFortitude.Card)) yield return null;
            //Legionary
